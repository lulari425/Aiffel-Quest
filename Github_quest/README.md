...
---
- 기사에 대한 회고
  - 인공지능 기술의 발달이 빨라지고 있지만, 아직까지 사회적 합의가 필요한 부분이 많기에 기술 성장 속도만큼 윤리적인 문제 등을 고민해야 될 필요가 있다는 것을 느 
    꼈고, 아직 안전장치가 확실하지 않기에 가짜 정보 등을 구별해야될 것이고 일자리 대체 문제에 대해서도 창의적인 인재들이 필요할 것이며, 추론능력이 중요하다는   
    것을 알 수 있었습니다.
